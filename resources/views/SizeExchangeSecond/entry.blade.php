...
<div class="well">
    ...
    <form action="/sizeexchangesecond/confirm/{{ $select }}/" id="f" name="f" method="post" accept-charset="utf-8">
        @csrf
                        ...
                        <td >
                            <?php
                                ...
                                echo show_select_amount(
                                        ...
                                        $s_no,
                                        $$s_no,
                                        empty($_POST[$s_no]) ? null : $_POST[$s_no],
                                        $orderDetail->amount,
                                ...
                                if($orderDetail->amount >= 10)
                                {
                                    echo show_text_amount(
                                        ...
                                        $t_no,
                                        $$t_no,
                                        empty($_POST[$t_no]) ? null : $_POST[$t_no],
                                        $$s_no,
                                        empty($_POST[$s_no]) ? null : $_POST[$s_no],
                                        $orderDetail->amount,
                                        $orderDetail->kbn_return,
